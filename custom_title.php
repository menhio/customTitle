...
$query->join('field_data_field_fecha_analisis_salud', 'f', 'f.entity_id = n.nid');
$query->join('field_data_field_tripulante_salud', 's', 's.entity_id = n.nid');

$query->join('node', 'n2', 'n2.nid = s.field_tripulante_salud_target_id');
$query->join('field_data_field_nombre_personal', 'nom', 'nom.entity_id = n2.nid');
$query->join('field_data_field_ap_paterno_personal', 'pat', 'pat.entity_id = n2.nid');
$query->join('field_data_field_ap_materno_personal', 'mat', 'mat.entity_id = n2.nid');
